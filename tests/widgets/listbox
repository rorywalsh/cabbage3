...
gentable bounds(12, 16, 354, 160), channel("soundfiler1"), file("808loop.wav"), tableNumber(1), colour(147, 210, 0), tableBackgroundColour(0, 0, 0, 0)
gentable bounds(12, 16, 354, 160), channel("soundfiler2"),file("808loop.wav"), tableNumber(2), alpha(0), colour(255, 255, 0), tableBackgroundColour(0, 0, 0, 0)
