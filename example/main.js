...
const widgetWrappers = null;//new WidgetWrapper(updatePanel);

//when widgetWrappers are valid, we are in vscode
if(widgetWrappers){
  const vscode = acquireVsCodeApi();
}
else{
  function sendParameterValueFromEditor(index, value){
...
async function insertWidget(type, props) {
  ...
  if (cabbageMode === 'playMode'  && widgetWrappers!=null){
