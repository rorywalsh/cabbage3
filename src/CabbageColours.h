...
class Colours
{
  public:
    ...
    static const std::string getColour(std::string colour)
    {
        static const std::unordered_map<std::string, std::string> cssColorMap = {{"aliceblue", "#F0F8FF"},
                                                                                 {"antiquewhite", "#FAEBD7"},
                                                                                 {"aqua", "#00FFFF"},
                                                                                 {"aquamarine", "#7FFFD4"},
                                                                                 {"azure", "#F0FFFF"},
        ...
        std::string lowerStr = colour;
        std::transform(lowerStr.begin(), lowerStr.end(), lowerStr.begin(), ::tolower);
        auto it = cssColorMap.find(lowerStr);
        if (it != cssColorMap.end())
        {
            return it->second; // Return the corresponding hex value
        }
        else
        {
