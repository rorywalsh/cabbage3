...
IWebView::IWebView(bool opaque) : mOpaque(opaque)
{
}
                ...
                env->CreateCoreWebView2Controller(
                    ...
                    Callback<ICoreWebView2CreateCoreWebView2ControllerCompletedHandler>(
                        [&, x, y, w, h, enableDevTools](HRESULT result, ICoreWebView2Controller *controller) -> HRESULT
                        {
                            ...
                            // this script adds a function IPlugSendMsg that is used to call the platform webview
                            // messaging function in JS
                            ...
                            if (!mOpaque)
                            {
                                wil::com_ptr<ICoreWebView2Controller2> controller2 =
                                    mWebViewCtrlr.query<ICoreWebView2Controller2>();
