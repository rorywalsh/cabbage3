...
public:
    ...
    void SendArbitraryMsgFromDelegate(int msgTag, int dataSize, const void* pData)
    {
        //  WDL_String str;
        //  std::vector<char> base64;
        //  if (dataSize)
    ...
    void SendMidiMsgFromDelegate(const iplug::IMidiMsg& msg)
    {
    ...
    void OnMessageFromWebView(const char* jsonStr)
    {
